...
## {#dataviz-history-minard data-menu-title="DataViz History"}
...
## {#dataviz-history-minard-2 data-menu-title="DataViz History"}

![“Carte figurative des pertes successives en hommes de l'Armée Française dans la campagne de Russie 1812–1813” and “Carte figurative des pertes successives en hommes de l'Armée qu'Annibal conduisit d'Espagne en Italie en traversant les Gaules (selon Polybe)” by Charles Joseph Minard (1869)](img/minard-full.png)
...
## {#dataviz-history-minard-3 data-menu-title="DataViz History"}
...
## {#dataviz-history-minard-4 data-menu-title="DataViz History"}
...
![“Diagram of the causes and mortality in the army in the East” by Florence Nightingale (1858)](img/nightingale-mortality.jpg)



## {#dataviz-history-nightingale-2 data-menu-title="DataViz History"}
...
::: {.column width="65%"}
![Source: The Economist](img/kobak-shpilkin.png)
:::
...
::: {.column width="65%"}
![Source: The Economist](img/kobak-shpilkin-zoom.png)
:::
...
# Data Pitfalls {background-color="#FFD166"}
...
&emsp;&emsp;→&ensp;not crime but <u>reported</u> crime<br>
...
## {#meteorites data-menu-title="Information: Completeness" background-color="#000000"}
...
## {#audience-5 data-menu-title="Who's My Audience?" background-image="img/audience-5.png" background-position="center"}
...
::: question
<b style='font-size:1.3em;'>Imagine you are working for a candy company and want to introduce a new type of candy.</b>
...
## {"img/exercise-what-now.png" background-position="center" background-size="75%"}
