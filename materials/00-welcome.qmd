...
# Welcome<br><br><br><br><br><br> {#course-logo-before data-menu-title="Course Logo Before" background-image="img/logo-welcome-before.png" background-position="center" background-size="40%"}
